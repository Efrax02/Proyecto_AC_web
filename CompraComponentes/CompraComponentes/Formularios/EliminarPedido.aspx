...
<body>
    <form id="form1" runat="server">
        ...
        <%--<asp:ObjectDataSource ID="or_MostrarCodPedido" runat="server" 
            SelectMethod="MostrarCodPedidos" 
        ...
        <asp:ObjectDataSource ID="or_EliminarPedidos" runat="server" SelectMethod="MostrarPedidosCodPedido" TypeName="CompraComponentes.App_Code.DB_Pedidos" DeleteMethod="EliminarPedido">
            <DeleteParameters>
        ...
        <asp:GridView ID="grdDatosLineasPedidos" runat="server" AutoGenerateColumns="False" DataSourceID="or_EliminarPedidos" AutoGenerateDeleteButton="True" DataKeyNames="CodPedido">
            <Columns>
